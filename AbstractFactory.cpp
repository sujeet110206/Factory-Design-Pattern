...
public:
    void prepare() override {
        cout << "Prepraing Basic Garlic Bread with btter, and gralic!" << endl;
    }
};
...
public:
    void prepare() override {
        cout << "Prepraing Cheese Garlic Bread with extra cheese and butter!" << endl;
    }
};
...
public:
    void prepare() override {
        cout << "Prepraing Basic Wheat Garlic Bread with butter, and garlic!" << endl;
    }
};
...
public:
    void prepare() override {
        cout << "Prepraing Cheese Wheat Garlic Bread with extra cheese and butter!" << endl;
    }
};
